...
export default function StepItem({
  ...
  return (
    <div
      className={`w-full ${style === "light" ? "bg-white hover:bg-black" : "bg-gray hover:bg-gray-light hover:border-l-2 hover:border-red"} transition-all duration-300 group p-8`}
    >
